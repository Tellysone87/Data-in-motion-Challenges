...
# Hard: Create a function to perform basic arithmetic operations that includes addition, subtraction, multiplication
...
# Notes:
# All the inputs are only integers. The operators are * – + and //.
