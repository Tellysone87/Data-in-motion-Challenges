...
def animals(chickens,cows,pigs):
    ...
    total_legs += cows * animal_leg_count.get("cow", 0) # chickens times the stored legs value
    total_legs += pigs * animal_leg_count.get("pig", 0) # chickens times the stored legs value
